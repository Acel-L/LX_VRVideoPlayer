...
@objc class LX360VideoVC: HorizontalScreenVC, SCNSceneRendererDelegate, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        leftSceneView = SCNView(frame: CGRectMake(0, 0, ScreenHeight / 2, ScreenWidth))
        rightSceneView = SCNView(frame: CGRectMake(ScreenHeight / 2, 0, ScreenHeight / 2, ScreenWidth))
        
        leftSceneView?.opaque = true;
        rightSceneView?.opaque = true;
        
        leftSceneView.clearsContextBeforeDrawing = true;
        rightSceneView.clearsContextBeforeDrawing = true;

        leftSceneView?.clipsToBounds = true;
        rightSceneView?.clipsToBounds = true;

        leftSceneView?.autoresizesSubviews = true;
        rightSceneView?.clipsToBounds = true;
...
//        let fileURL: NSURL? = NSURL(string: "http://120.24.154.227:8091/videos/mp4/aee3cb66c5b1288d2dfd09340290bd04_720p.mp4")
...
//        stopPlay()
    ...
    func backBtnAction(sender : UIButton) {
        ...
        leftSceneView.removeFromSuperview()

        rightSceneView.removeFromSuperview()
